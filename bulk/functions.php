...
if ( !function_exists( 'bulk_generate_construct_footer' ) ) :
	...
	function bulk_generate_construct_footer() {
		...
		<p class="footer-credits-text text-center">
			...
			printf( esc_html__( 'Design by %s', 'bulk' ), '<a href="' . esc_url( __( 'https://wordpress.org/', 'bulk' ) ) . '">ReSoccer</a>' );
			?>
			<span class="sep"> | </span>
			<?php
			/* translators: %1$s: link to theme page */
			printf( esc_html__( 'Theme: %1$s', 'bulk' ), '<a href="https://themes4wp.com/">Bulk Childtheme</a>' );
			?>
		</p>
		<?php
	}
